lamp_ikea = {'capabilities': {'type': 'SET',
                  'values': ['IDENTIFY',
                             'ALERT',
                             'ON_OFF',
                             'CONTROL_LIGHT',
...
lamp_osram = {'capabilities': {'type': 'SET',
                  'values': ['IDENTIFY',
                             'ALERT',
                             'ON_OFF',
                             'CONTROL_LIGHT',
...
strip_osram = {'capabilities': {'type': 'SET',
                  'values': ['IDENTIFY',
                             'ALERT',
                             'ON_OFF',
                             'CONTROL_LIGHT',
...
twilight_nexa = {'capabilities': {'type': 'SET', 'values': ['DEVICE', 'TWILIGHT']},
 'description': None,
 'deviceType': None,
 'groups': [],
...
plafond_osram = {'capabilities': {'type': 'SET',
                  'values': ['IDENTIFY',
                             'ALERT',
                             'ON_OFF',
                             'CONTROL_LIGHT',
